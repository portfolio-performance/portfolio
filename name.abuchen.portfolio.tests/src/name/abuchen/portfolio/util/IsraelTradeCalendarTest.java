...
public class IsraelTradeCalendarTest
{
    ...
    public void testJewishCalendar()
    {
        ...
        // FAST_DAY Tisha B'Av
        assertThat(type.getTishBAv(2024), is(LocalDate.of(2024, 8, 13)));
        assertThat(type.getTishBAv(2025), is(LocalDate.of(2025, 8, 3)));
        assertThat(type.getTishBAv(2026), is(LocalDate.of(2026, 7, 23)));
        ...
        // NEWYEARI,
        assertThat(type.getRoshHashanahI(2024), is(LocalDate.of(2024, 10, 3)));
        assertThat(type.getRoshHashanahI(2025), is(LocalDate.of(2025, 9, 23)));
        assertThat(type.getRoshHashanahI(2026), is(LocalDate.of(2026, 9, 12)));
        // NEWYEARII,
        ...
        // YOM_KIPUR,
        assertThat(type.getYomKippur(2024), is(LocalDate.of(2024, 10, 12)));
        assertThat(type.getYomKippur(2025), is(LocalDate.of(2025, 10, 2)));
        assertThat(type.getYomKippur(2026), is(LocalDate.of(2026, 9, 21)));
        ...
        assertThat(type.getErevSimhatTorah(2024), is(LocalDate.of(2024, 10, 23)));
        assertThat(type.getErevSimhatTorah(2025), is(LocalDate.of(2025, 10, 13)));
        assertThat(type.getErevSimhatTorah(2026), is(LocalDate.of(2026, 10, 2)));

        // SIMCHAT_TORA; if (hebDay == 23 && hebMonth == 7)
        assertThat(type.getSimhatTorah(2024), is(LocalDate.of(2024, 10, 24)));
        assertThat(type.getSimhatTorah(2025), is(LocalDate.of(2025, 10, 14)));
        assertThat(type.getSimhatTorah(2026), is(LocalDate.of(2026, 10, 3)));
