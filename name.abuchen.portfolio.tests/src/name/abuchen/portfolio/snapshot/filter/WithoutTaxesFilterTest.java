...
public class WithoutTaxesFilterTest
{
    ...
    public void testThatFilteringThenDerivingCostOnSpinOffDoesNotThrow()
    {
        ...
        // code under test: WithoutTaxesFilter copies the distribution legs
        // without a CorporateActionEntry cross-entry link, so basis
        ...
        Client filtered = new WithoutTaxesFilter().filter(spinOffClient);
