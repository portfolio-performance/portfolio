...
public class LedgerParameterCodeDomainTest
{
    private static final Map<LedgerParameterCodeDomain, List<String>> EXPECTED_CODES = Map.ofEntries(
                    ...
                    Map.entry(LedgerParameterCodeDomain.CORPORATE_ACTION_KIND,
                                    List.of("CASH_DISTRIBUTION", "STOCK_DIVIDEND", "SPIN_OFF", "BONUS_ISSUE",
                                                    "RIGHTS_DISTRIBUTION", "COUPON_PAYMENT", "PIK_INTEREST",
                                                    "DEFAULTED_INTEREST", "MATURITY", "PARTIAL_REDEMPTION", "CALL",
                                                    "PUT", "CONVERSION", "EXCHANGE", "RESTRUCTURING", "DEFAULT")),
                    Map.entry(LedgerParameterCodeDomain.CORPORATE_ACTION_SUBTYPE,
                                    List.of("STANDARD", "OPTIONAL", "MANDATORY", "CASH_AND_STOCK", "OTHER")),
                    Map.entry(LedgerParameterCodeDomain.CORPORATE_ACTION_BASIS_STATUS,
                                    List.of("NOT_APPLICABLE", "UNKNOWN", "PROVIDED")),
                    Map.entry(LedgerParameterCodeDomain.CORPORATE_ACTION_BASIS_METHOD,
                                    List.of("UNSPECIFIED", "PERCENTAGE_ALLOCATION", "AMOUNT_ALLOCATION",
                                                    "REFERENCE_PRICE_RATIO", "FAIR_MARKET_VALUE_RATIO",
                                                    "MANUAL_OVERRIDE")),
