...
public class LedgerParameterTest
{
    ...
    public void testOfCodeRejectsWrongDomain()
    {
        ...
        assertThat(exception.getMessage(), containsString(LedgerDiagnosticCode.LEDGER_CORE_010.prefix()));
    ...
    public void testOfCodeRejectsNonCodeDomainParameter()
    {
        ...
        assertThat(exception.getMessage(), containsString(LedgerDiagnosticCode.LEDGER_CORE_009.prefix()));
    ...
    public void testOfCodeRejectsNonStringParameter()
    {
        ...
        assertThat(exception.getMessage(), containsString(LedgerDiagnosticCode.LEDGER_CORE_018.prefix()));
