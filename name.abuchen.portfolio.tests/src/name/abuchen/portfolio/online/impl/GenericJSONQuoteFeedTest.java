...
public class GenericJSONQuoteFeedTest
{
    ...
    @Test
    public void testNoFeedUrl() throws IOException, URISyntaxException
    {
        GenericJSONQuoteFeed feed = Mockito.spy(new GenericJSONQuoteFeed());
    ...
    @Test
    public void testNoExtractionProperties() throws IOException, URISyntaxException
    {
    ...
    @Test
    public void testDateExtractionInteger() throws IOException, URISyntaxException
    {
    ...
    @Test
    public void testDateExtractionLong() throws IOException, URISyntaxException
    {
    ...
    @Test
    public void testDateExtractionLongDays() throws IOException, URISyntaxException
    {
    ...
    @Test
    public void testDateExtractionDouble() throws IOException, URISyntaxException
    {
    ...
    @Test
    public void testDateExtractionInvalid() throws IOException, URISyntaxException
    {
    ...
    @Test
    public void testValueExtractionInteger() throws IOException, URISyntaxException, ParseException
    {
    ...
    @Test
    public void testValueExtractionIntegerInvalid() throws IOException, URISyntaxException, ParseException
    {
    ...
    {
        JsonPath path = JsonPath.compile(security.getPropertyValue(SecurityProperty.Type.FEED, type).get());
