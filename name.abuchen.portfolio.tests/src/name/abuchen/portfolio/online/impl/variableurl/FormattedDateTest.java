...
public class FormattedDateTest
{
    ...
    public void testVariations()
    {
        ...
        date = LocalDate.now();
        assertVariations(new Security(), Arrays.asList(date, date.minusMonths(1), date.minusMonths(2), date.minusMonths(3)));
    ...
    private void assertMaxFailedAttempts(String variableURL, int maxFailedAttempts)
    {
