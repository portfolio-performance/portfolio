...
public class CSVAccountTransactionExtractorTest
{
    ...
    public void testDetectionOfFeeRefunds()
    {
        ...
        assertThat(results.size(), is(2));
        new AssertImportActions().check(results, "UNDEFINED");
        ...
        assertThat(t1.getMonetaryAmount(), is(Money.of("UNDEFINED", Values.Amount.factorize(10))));
        ...
        assertThat(t2.getMonetaryAmount(), is(Money.of("UNDEFINED", Values.Amount.factorize(20))));
    }
}
