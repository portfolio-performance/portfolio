...
public class Direkt1822BankPDFExtractorTest
{
    ...
    public void testDividende01()
    {
        ...
        // check security
        assertThat(results, hasItem(security( //
                        hasIsin("IE00BYM31M36"), hasWkn("A2AFCX"), hasTicker(null), //
                        hasName("ISHSIV-FA.AN.HI.YI.CO.BD U.ETF REGISTERED SHARES USD O.N."), //
                        hasCurrencyCode("USD"))));

        // check dividends transaction
        assertThat(results, hasItem(dividend( //
                        hasDate("2018-01-03T00:00"), hasExDate("2017-12-14T00:00"), //
                        hasShares(920), //
                        hasSource("Dividende01.txt"), //
                        hasNote("Abrechnungsnr. 504xxxxxxxx"), //
                        hasAmount("EUR", 68.87), hasGrossValue("EUR", 93.56), //
                        hasForexGrossValue("USD", 113.16), //
                        hasTaxes("EUR", 23.41 + 1.28), hasFees("EUR", 0.00))));
    }
    ...
    public void testDividende02()
    {
        ...
        // check security
        assertThat(results, hasItem(security( //
                        hasIsin("DE000ETFL078"), hasWkn("ETFL07"), hasTicker(null), //
                        hasName("DEKA EO STOXX SEL.DIV.30 U.ETF INHABER-ANTEILE"), //
                        hasCurrencyCode("EUR"))));

        // check dividends transaction
        assertThat(results, hasItem(dividend( //
                        hasDate("2021-03-10T00:00"), hasExDate("2021-03-10T00:00"), //
                        hasShares(118.901), //
                        hasSource("Dividende02.txt"), //
                        hasNote("Abrechnungsnr. 56838700560"), //
                        hasAmount("EUR", 7.13), hasGrossValue("EUR", 7.13), //
                        hasTaxes("EUR", 0.00), hasFees("EUR", 0.00))));
    }
    ...
    public void testDividende03()
    {
        ...
        assertThat(results, hasItem(security( //
                        ...
                        hasName("EXXON MOBIL CORP. REGISTERED SHARES O.N."), //
                        hasCurrencyCode("USD"))));

        // check dividends transaction
        assertThat(results, hasItem(dividend( //
                        hasDate("2021-03-12T00:00"), hasExDate("2021-02-09T00:00"), //
                        hasShares(6), //
                        hasSource("Dividende03.txt"), //
                        hasNote("Abrechnungsnr. 11111111122"), //
                        hasAmount("EUR", 3.72), hasGrossValue("EUR", 4.38), //
                        hasForexGrossValue("USD", 5.22), //
    ...
    public void testDividende04()
    {
        ...
        // check dividends transaction
        assertThat(results, hasItem(dividend( //
                        hasDate("2024-03-20T00:00"), hasExDate("2024-03-14T00:00"), //
                        hasShares(20.00), //
