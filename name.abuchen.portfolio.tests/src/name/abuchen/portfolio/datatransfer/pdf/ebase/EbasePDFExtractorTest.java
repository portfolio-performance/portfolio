...
public class EbasePDFExtractorTest
{
    ...
    public void testUmsatzabrechnung01()
    {
        ...
        assertThat(entry.getPortfolioTransaction().getDateTimeValue(), is(LocalDateTime.parse("2019-11-21T00:00")));
    ...
    public void testUmsatzabrechnung02()
    {
        ...
        assertThat(entry.getPortfolioTransaction().getDateTimeValue(), is(LocalDateTime.parse("2020-01-02T00:00")));
        ...
        assertThat(entry.getPortfolioTransaction().getDateTimeValue(), is(LocalDateTime.parse("2020-01-20T00:00")));
        ...
        assertThat(transaction.getDateTimeValue(), is(LocalDateTime.parse("2020-01-24T00:00")));
    ...
    public void testUmsatzabrechnung03()
    {
        ...
        assertThat(entry.getPortfolioTransaction().getDateTimeValue(), is(LocalDateTime.parse("2020-01-27T00:00")));
        ...
        assertThat(entry.getPortfolioTransaction().getDateTimeValue(), is(LocalDateTime.parse("2019-10-22T00:00")));
        assertThat(entry.getPortfolioTransaction().getShares(), is(Values.Share.factorize(1.705860)));
        assertThat(entry.getSource(), is("Umsatzabrechnung03.txt"));
        ...
        assertThat(transaction.getDateTimeValue(), is(LocalDateTime.parse("2019-10-16T00:00")));
    ...
    public void testUmsatzabrechnung05()
    {
        ...
        assertThat(entry.getPortfolioTransaction().getDateTimeValue(), is(LocalDateTime.parse("2017-05-03T00:00")));
        ...
        assertThat(entry.getPortfolioTransaction().getDateTimeValue(), is(LocalDateTime.parse("2017-12-22T00:00")));
        ...
        assertThat(transaction.getDateTimeValue(), is(LocalDateTime.parse("2017-12-22T00:00")));
    ...
    public void testUmsatzabrechnung06()
    {
        ...
        assertThat(entry.getPortfolioTransaction().getDateTimeValue(), is(LocalDateTime.parse("2016-06-04T00:00")));
    ...
    public void testUmsatzabrechnung07()
    {
        ...
        assertThat(transaction.getDateTimeValue(), is(LocalDateTime.parse("2020-07-30T00:00")));
        ...
        assertThat(entry.getPortfolioTransaction().getDateTimeValue(), is(LocalDateTime.parse("2020-08-03T00:00")));
    ...
    public void testUmsatzabrechnung08()
    {
        ...
        assertThat(entry.getPortfolioTransaction().getDateTimeValue(), is(LocalDateTime.parse("2020-10-29T00:00")));
        ...
        assertThat(entry.getPortfolioTransaction().getDateTimeValue(), is(LocalDateTime.parse("2020-11-27T00:00")));
        ...
        assertThat(entry.getPortfolioTransaction().getDateTimeValue(), is(LocalDateTime.parse("2020-12-23T00:00")));
    ...
    public void testUmsatzabrechnung09()
    {
        ...
        assertThat(transaction.getDateTimeValue(), is(LocalDateTime.parse("2019-11-28T00:00")));
        ...
        assertThat(entry.getPortfolioTransaction().getDateTimeValue(), is(LocalDateTime.parse("2019-12-02T00:00")));
    ...
    public void testUmsatzabrechnung10()
    {
        ...
        assertThat(entry.getPortfolioTransaction().getDateTimeValue(), is(LocalDateTime.parse("2020-10-19T00:00")));
        ...
        assertThat(entry.getPortfolioTransaction().getDateTimeValue(), is(LocalDateTime.parse("2020-12-17T00:00")));
    ...
    public void testUmsatzabrechnung11()
    {
        ...
        assertThat(entry.getPortfolioTransaction().getDateTimeValue(), is(LocalDateTime.parse("2021-04-06T00:00")));
        ...
        assertThat(transaction.getDateTimeValue(), is(LocalDateTime.parse("2021-04-06T00:00")));
    ...
    public void testUmsatzabrechnung12()
    {
        ...
        assertThat(entry.getPortfolioTransaction().getDateTimeValue(), is(LocalDateTime.parse("2022-01-03T00:00")));
        ...
        assertThat(entry.getPortfolioTransaction().getDateTimeValue(), is(LocalDateTime.parse("2022-01-07T00:00")));
        ...
        assertThat(transaction.getDateTimeValue(), is(LocalDateTime.parse("2022-01-07T00:00")));
    ...
    public void testUmsatzabrechnung13()
    {
        ...
        assertThat(entry.getPortfolioTransaction().getDateTimeValue(), is(LocalDateTime.parse("2021-07-05T00:00")));
        ...
        assertThat(transaction.getDateTimeValue(), is(LocalDateTime.parse("2021-07-05T00:00")));
    ...
    public void testUmsatzabrechnung14()
    {
        ...
        assertThat(entry.getPortfolioTransaction().getDateTimeValue(), is(LocalDateTime.parse("2021-07-02T00:00")));
    ...
    public void testUmsatzabrechnung15()
    {
        ...
        assertThat(entry.getPortfolioTransaction().getDateTimeValue(), is(LocalDateTime.parse("2021-05-04T00:00")));
        ...
        assertThat(transaction.getDateTimeValue(), is(LocalDateTime.parse("2021-06-14T00:00")));
    ...
    public void testUmsatzabrechnung16()
    {
        ...
        assertThat(entry.getPortfolioTransaction().getDateTimeValue(), is(LocalDateTime.parse("2021-01-25T00:00")));
        ...
        assertThat(entry.getPortfolioTransaction().getDateTimeValue(), is(LocalDateTime.parse("2021-01-26T00:00")));
        ...
        assertThat(entry.getPortfolioTransaction().getDateTimeValue(), is(LocalDateTime.parse("2021-03-02T00:00")));
    ...
    public void testUmsatzabrechnung17()
    {
        ...
        assertThat(entry.getPortfolioTransaction().getDateTimeValue(), is(LocalDateTime.parse("2020-12-01T00:00")));
        ...
        assertThat(entry.getPortfolioTransaction().getDateTimeValue(), is(LocalDateTime.parse("2020-12-03T00:00")));
        ...
        assertThat(entry.getPortfolioTransaction().getDateTimeValue(), is(LocalDateTime.parse("2020-12-02T00:00")));
    ...
    public void testUmsatzabrechnung19()
    {
        ...
        assertThat(entry.getPortfolioTransaction().getDateTimeValue(), is(LocalDateTime.parse("2020-12-28T00:00")));
    ...
    public void testUmsatzabrechnung21()
    {
        ...
        assertThat(entry.getPortfolioTransaction().getDateTimeValue(), is(LocalDateTime.parse("2016-01-18T00:00")));
    ...
    public void testUmsatzabrechnung22()
    {
        ...
        assertThat(entry.getPortfolioTransaction().getDateTimeValue(), is(LocalDateTime.parse("2018-10-30T00:00")));
    ...
    public void testUmsatzabrechnung23()
    {
        ...
        assertThat(entry.getPortfolioTransaction().getDateTimeValue(), is(LocalDateTime.parse("2021-08-03T00:00")));
        ...
        assertThat(entry.getPortfolioTransaction().getDateTimeValue(), is(LocalDateTime.parse("2021-08-09T00:00")));
    ...
    public void testUmsatzabrechnung25()
    {
        ...
        assertThat(entry.getPortfolioTransaction().getDateTimeValue(), is(LocalDateTime.parse("2022-06-20T00:00")));
    ...
    public void testDepotStatement01()
    {
        ...
        assertThat(transaction.getDateTimeValue(), is(LocalDateTime.parse("2022-12-12T00:00")));
