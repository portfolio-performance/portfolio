...
public class EbasePDFExtractorTest
{
    ...
    {       
        ...
        transaction = (AccountTransaction) results.stream().filter(i -> i instanceof TransactionItem).skip(2).findFirst()
                        .orElseThrow(IllegalArgumentException::new).getSubject();
        ...
        transaction = (AccountTransaction) results.stream().filter(i -> i instanceof TransactionItem).skip(3).findFirst()
                        .orElseThrow(IllegalArgumentException::new).getSubject();
        ...
        transaction = (AccountTransaction) results.stream().filter(i -> i instanceof TransactionItem).skip(4).findFirst()
                        .orElseThrow(IllegalArgumentException::new).getSubject();
