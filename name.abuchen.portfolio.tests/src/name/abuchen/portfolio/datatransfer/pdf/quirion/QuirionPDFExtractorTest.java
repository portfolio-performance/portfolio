...
public class QuirionPDFExtractorTest
{
    ...
    public void testQuirionKontoauszug01()
    {
        ...
        List<Item> results = extractor.extract(
                        PDFInputFile.loadTestCase(getClass(), "Kontoauszug01.txt"), errors);
        ...
        if (iter.hasNext())
        {
            ...
            assertThat(entry.getPortfolioTransaction().getGrossValue().getAmount(), is(Values.Amount.factorize(428.06)));
        ...
        if (iter.hasNext())
        {
            ...
            assertThat(entry.getPortfolioTransaction().getGrossValue().getAmount(), is(Values.Amount.factorize(408.26)));
        ...
        if (iter.hasNext())
        {
            ...
            assertThat(entry.getPortfolioTransaction().getGrossValue().getAmount(), is(Values.Amount.factorize(235.86)));
        ...
        if (iter.hasNext())
        {
            ...
            //assertThat(entry.getPortfolioTransaction().getGrossValue().getAmount(), is(Values.Amount.factorize(110.86))); //TODO
        ...
        if (iter.hasNext())
        {
            ...
            assertThat(transaction.getCurrencyCode(), is(CurrencyUnit.EUR));
            assertThat(transaction.getGrossValue().getAmount(), is(Values.Amount.factorize(158.23))); //TODO
        ...
        if (iter.hasNext())
        {
            ...
            assertThat(transaction.getCurrencyCode(), is(CurrencyUnit.EUR));
            assertThat(transaction.getGrossValue().getAmount(), is(Values.Amount.factorize(14.52))); //TODO
            //assertThat(transaction.getGrossValue().getCurrencyCode(), is("USD"));
        }
        if (iter.hasNext())
        {
            // get transaction13
            ...
            assertThat(transaction.getCurrencyCode(), is(CurrencyUnit.EUR));
            assertThat(transaction.getGrossValue().getAmount(), is(Values.Amount.factorize(1.17))); //TODO
            //assertThat(transaction.getGrossValue().getCurrencyCode(), is("USD"));
        }
        if (iter.hasNext())
        {
