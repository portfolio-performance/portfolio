...
public class OnvistaPDFExtractorTest
{
    ...
    public void testDividendeWithCashCompensation01()
    {
        ...
        assertThat(entry.getDateTime(), is(LocalDateTime.parse("2013-06-11T00:00")));
        assertThat(entry.getShares(), is(Values.Share.factorize(25)));
        ...
        // check buy sell transaction
        BuySellEntry entry2 = (BuySellEntry) results.stream().filter(BuySellEntryItem.class::isInstance)
                        .collect(Collectors.toList()).get(0).getSubject();

        assertThat(entry2.getPortfolioTransaction().getType(), is(PortfolioTransaction.Type.SELL));
        assertThat(entry2.getAccountTransaction().getType(), is(AccountTransaction.Type.SELL));

        assertThat(entry2.getPortfolioTransaction().getDateTime(), is(LocalDateTime.parse("2013-06-11T00:00")));
        ...
        assertThat(entry2.getPortfolioTransaction().getMonetaryAmount(),
                        is(Money.of(CurrencyUnit.EUR, Values.Amount.factorize(17.50))));
        assertThat(entry2.getPortfolioTransaction().getGrossValue(),
                        is(Money.of(CurrencyUnit.EUR, Values.Amount.factorize(17.50))));
        assertThat(entry2.getPortfolioTransaction().getUnitSum(Unit.Type.TAX),
                        is(Money.of(CurrencyUnit.EUR, Values.Amount.factorize(0.00))));
    ...
    public void testZwangsabfindung01()
    {
        ...
        assertThat(entry.getDateTime(), is(LocalDateTime.parse("2015-09-22T00:00")));
        assertThat(entry.getShares(), is(Values.Share.factorize(25)));
        ...
        assertThat(entry2.getPortfolioTransaction().getDateTime(), is(LocalDateTime.parse("2015-09-22T00:00")));
        assertThat(entry2.getPortfolioTransaction().getShares(), is(Values.Share.factorize(25)));
    ...
    public void testUmtausch02()
    {
        ...
        assertThat(entry.getGrossValue(),
                        is(Money.of(CurrencyUnit.EUR, Values.Amount.factorize(25.72))));
        assertThat(entry.getUnitSum(Unit.Type.TAX),
