...
public class DkbPDFExtractorTest
{
    ...
    public void testWertpapierStornoVerkauf01()
    {
        ...
        assertThat(cancelations.getPortfolioTransaction().getDateTime(), is(LocalDateTime.parse("2021-01-05T00:00")));
        assertThat(cancelations.getPortfolioTransaction().getShares(), is(Values.Share.factorize(16.3986)));
        assertThat(cancelations.getSource(), is("StornoVerkauf01.txt"));
