...
public class BaaderBankPDFExtractorTest
{
    ...
    public void testWertpapierKauf10()
    {
        ...
        assertThat(entry.getNote(), is("Verhältnis: 1 : 1"));
    ...
    public void testDividendeStorno01()
    {
        ...
        assertThat(cancelations.getDateTime(), is(LocalDateTime.parse("2022-06-13T00:00")));
        assertThat(cancelations.getShares(), is(Values.Share.factorize(10.672)));
        assertThat(cancelations.getSource(), is("DividendeStorno01.txt"));
        ...
        assertThat(cancelations.getMonetaryAmount(),
                        is(Money.of(CurrencyUnit.EUR, Values.Amount.factorize(7.04))));
    ...
    public void testDividendeStorno02()
    {
        ...
        assertThat(cancelations.getDateTime(), is(LocalDateTime.parse("2021-10-18T00:00")));
        assertThat(cancelations.getShares(), is(Values.Share.factorize(250)));
        assertThat(cancelations.getSource(), is("DividendeStorno02.txt"));
        assertThat(cancelations.getNote(), is(Messages.MsgErrorOrderCancellationUnsupported));
