...
public class DeutscheBankPDFExtractorTest
{
    ...
    public void testDividende03()
    {
        ...
        assertThat(transaction.getDateTimeValue(), is(LocalDateTime.parse("2015-03-24T00:00")));
    ...
    public void testDividende04()
    {
        ...
        assertThat(transaction.getDateTimeValue(), is(LocalDateTime.parse("2019-05-31T00:00")));
    ...
    public void testDividende05()
    {
        ...
        assertThat(transaction.getDateTimeValue(), is(LocalDateTime.parse("2021-11-26T00:00")));
    ...
    public void testWertpapierKauf02()
    {
        ...
        assertThat(entry.getPortfolioTransaction().getDateTimeValue(), is(LocalDateTime.parse("2015-04-02T09:04")));
    ...
    public void testWertpapierKauf03()
    {
        ...
        assertThat(entry.getPortfolioTransaction().getDateTimeValue(), is(LocalDateTime.parse("2019-08-20T00:00")));
    ...
    public void testWertpapierKauf04()
    {
        ...
        assertThat(entry.getPortfolioTransaction().getDateTimeValue(), is(LocalDateTime.parse("2021-08-20T09:04")));
    ...
    public void testWertpapierKauf05()
    {
        ...
        assertThat(entry.getPortfolioTransaction().getDateTimeValue(), is(LocalDateTime.parse("2021-12-20T09:09")));
    ...
    public void testWertpapierKauf06()
    {
        ...
        assertThat(entry.getPortfolioTransaction().getDateTimeValue(), is(LocalDateTime.parse("2021-12-20T09:04")));
    ...
    public void testWertpapierVerkauf03()
    {
        ...
        assertThat(entry.getPortfolioTransaction().getDateTimeValue(), is(LocalDateTime.parse("2017-02-16T15:28")));
    ...
    public void testWertpapierVerkauf04()
    {
        ...
        assertThat(entry.getPortfolioTransaction().getDateTimeValue(), is(LocalDateTime.parse("2022-07-07T09:05")));
    ...
    public void testGiroKontoauszug01()
    {
        ...
        transaction = (AccountTransaction) item.getSubject();
        assertThat(transaction.getType(), is(AccountTransaction.Type.REMOVAL));
        assertThat(transaction.getDateTimeValue(), is(LocalDateTime.parse("2020-11-05T00:00")));
        ...
        assertThat(transaction.getDateTimeValue(), is(LocalDateTime.parse("2020-11-06T00:00")));
        ...
        transaction = (AccountTransaction) item.getSubject();
        assertThat(transaction.getType(), is(AccountTransaction.Type.DEPOSIT));
        assertThat(transaction.getDateTimeValue(), is(LocalDateTime.parse("2020-11-16T00:00")));
        ...
        transaction = (AccountTransaction) item.getSubject();
        assertThat(transaction.getType(), is(AccountTransaction.Type.REMOVAL));
        assertThat(transaction.getDateTimeValue(), is(LocalDateTime.parse("2020-11-19T00:00")));
        ...
        transaction = (AccountTransaction) item.getSubject();
        assertThat(transaction.getType(), is(AccountTransaction.Type.DEPOSIT));
        assertThat(transaction.getDateTimeValue(), is(LocalDateTime.parse("2020-11-27T00:00")));
    ...
    public void testGiroKontoauszug02()
    {
        ...
        transaction = (AccountTransaction) item.getSubject();
        assertThat(transaction.getType(), is(AccountTransaction.Type.REMOVAL));
        assertThat(transaction.getDateTimeValue(), is(LocalDateTime.parse("2020-12-08T00:00")));
        ...
        transaction = (AccountTransaction) item.getSubject();
        assertThat(transaction.getType(), is(AccountTransaction.Type.REMOVAL));
        assertThat(transaction.getDateTimeValue(), is(LocalDateTime.parse("2020-12-09T00:00")));
        ...
        transaction = (AccountTransaction) item.getSubject();
        assertThat(transaction.getType(), is(AccountTransaction.Type.DEPOSIT));
        assertThat(transaction.getDateTimeValue(), is(LocalDateTime.parse("2020-12-14T00:00")));
        assertThat(transaction.getMonetaryAmount(), is(Money.of("EUR", Values.Amount.factorize(150.12))));
        assertThat(transaction.getSource(), is("GiroKontoauszug02.txt"));
        ...
        transaction = (AccountTransaction) item.getSubject();
        assertThat(transaction.getType(), is(AccountTransaction.Type.DEPOSIT));
        assertThat(transaction.getDateTimeValue(), is(LocalDateTime.parse("2020-12-21T00:00")));
        ...
        transaction = (AccountTransaction) item.getSubject();
        assertThat(transaction.getType(), is(AccountTransaction.Type.DEPOSIT));
        assertThat(transaction.getDateTimeValue(), is(LocalDateTime.parse("2020-12-30T00:00")));
    ...
    public void testGiroKontoauszug03()
    {
        ...
        transaction = (AccountTransaction) item.getSubject();
        assertThat(transaction.getType(), is(AccountTransaction.Type.REMOVAL));
        assertThat(transaction.getDateTimeValue(), is(LocalDateTime.parse("2021-01-05T00:00")));
        ...
        transaction = (AccountTransaction) item.getSubject();
        assertThat(transaction.getType(), is(AccountTransaction.Type.REMOVAL));
        assertThat(transaction.getDateTimeValue(), is(LocalDateTime.parse("2021-01-19T00:00")));
        ...
        transaction = (AccountTransaction) item.getSubject();
        assertThat(transaction.getType(), is(AccountTransaction.Type.REMOVAL));
        assertThat(transaction.getDateTimeValue(), is(LocalDateTime.parse("2021-01-20T00:00")));
        ...
        transaction = (AccountTransaction) item.getSubject();
        assertThat(transaction.getType(), is(AccountTransaction.Type.REMOVAL));
        assertThat(transaction.getDateTimeValue(), is(LocalDateTime.parse("2021-01-26T00:00")));
    ...
    public void testGiroKontoauszug04()
    {
        ...
        transaction = (AccountTransaction) item.getSubject();
        assertThat(transaction.getType(), is(AccountTransaction.Type.REMOVAL));
        assertThat(transaction.getDateTimeValue(), is(LocalDateTime.parse("2021-02-02T00:00")));
        assertThat(transaction.getMonetaryAmount(), is(Money.of("EUR", Values.Amount.factorize(1000.00))));
        assertThat(transaction.getSource(), is("GiroKontoauszug04.txt"));
        assertThat(transaction.getNote(), is("Dauerauftrag an Mustermann, Max"));
        ...
        transaction = (AccountTransaction) item.getSubject();
        assertThat(transaction.getType(), is(AccountTransaction.Type.REMOVAL));
        assertThat(transaction.getDateTimeValue(), is(LocalDateTime.parse("2021-02-04T00:00")));
        ...
        transaction = (AccountTransaction) item.getSubject();
        assertThat(transaction.getType(), is(AccountTransaction.Type.REMOVAL));
        assertThat(transaction.getDateTimeValue(), is(LocalDateTime.parse("2021-02-05T00:00")));
        ...
        transaction = (AccountTransaction) item.getSubject();
        assertThat(transaction.getType(), is(AccountTransaction.Type.DEPOSIT));
        assertThat(transaction.getDateTimeValue(), is(LocalDateTime.parse("2021-02-09T00:00")));
        assertThat(transaction.getMonetaryAmount(), is(Money.of("EUR", Values.Amount.factorize(438.00))));
        assertThat(transaction.getSource(), is("GiroKontoauszug04.txt"));
        assertThat(transaction.getNote(), is("Überweisung von Unser Sparverein"));
        ...
        transaction = (AccountTransaction) item.getSubject();
        assertThat(transaction.getType(), is(AccountTransaction.Type.REMOVAL));
        assertThat(transaction.getDateTimeValue(), is(LocalDateTime.parse("2021-02-10T00:00")));
        ...
        transaction = (AccountTransaction) item.getSubject();
        assertThat(transaction.getType(), is(AccountTransaction.Type.REMOVAL));
        assertThat(transaction.getDateTimeValue(), is(LocalDateTime.parse("2021-02-16T00:00")));
        ...
        transaction = (AccountTransaction) item.getSubject();
        assertThat(transaction.getType(), is(AccountTransaction.Type.REMOVAL));
        assertThat(transaction.getDateTimeValue(), is(LocalDateTime.parse("2021-02-19T00:00")));
        assertThat(transaction.getMonetaryAmount(), is(Money.of("EUR", Values.Amount.factorize(365.00))));
        assertThat(transaction.getSource(), is("GiroKontoauszug04.txt"));
        assertThat(transaction.getNote(), is("Überweisung an Mustermann, Max"));
        ...
        transaction = (AccountTransaction) item.getSubject();
        assertThat(transaction.getType(), is(AccountTransaction.Type.DEPOSIT));
        assertThat(transaction.getDateTimeValue(), is(LocalDateTime.parse("2021-02-26T00:00")));
        assertThat(transaction.getMonetaryAmount(), is(Money.of("EUR", Values.Amount.factorize(309.00))));
        assertThat(transaction.getSource(), is("GiroKontoauszug04.txt"));
        assertThat(transaction.getNote(), is("Überweisung von Landeshauptstadt Stadt Stadtverwaltung"));
    }
