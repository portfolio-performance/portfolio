...
public class ComdirectPDFExtractorTest
{
    ...
    public void testDividende01()
    {
        ...
        assertThat(results, hasItem(dividend( //
                        hasDate("2018-02-19T00:00"), hasExDate(null), //
                        hasShares(0.316), //
    ...
    public void testDividende02()
    {
        ...
        // check dividends transaction
        assertThat(results, hasItem(dividend( //
                        hasDate("2020-06-04T00:00"), hasExDate(null), //
                        hasShares(13.944), //
    ...
    public void testDividende03()
    {
        ...
        // check dividends transaction
        assertThat(results, hasItem(dividend( //
                        hasDate("2013-04-24T00:00"), hasExDate(null), //
                        hasShares(4.00), //
    ...
    public void testDividende04()
    {
        ...
        // check dividends transaction
        assertThat(results, hasItem(dividend( //
                        hasDate("2023-05-08T00:00"), hasExDate(null), //
                        hasShares(18.102), //
    ...
    public void testDividende05()
    {
        ...
        // check dividends transaction
        assertThat(results, hasItem(dividend( //
                        hasDate("2023-03-23T00:00"), hasExDate(null), //
                        hasShares(24.334), //
    ...
    public void testDividende06()
    {
        ...
        // check dividends transaction
        assertThat(results, hasItem(dividend( //
                        hasDate("2015-03-23T00:00"), hasExDate(null), //
                        hasShares(11.971), //
    ...
    public void testDividende07()
    {
        ...
        // check dividends transaction
        assertThat(results, hasItem(dividend( //
                        hasDate("2006-08-15T00:00"), hasExDate(null), //
                        hasShares(151.00), //
    ...
    public void testDividende08()
    {
        ...
        // check dividends transaction
        assertThat(results, hasItem(dividend( //
                        hasDate("2023-01-16T00:00"), hasExDate(null), //
                        hasShares(322.933), //
    ...
    public void testDividende09()
    {
        ...
        // check dividends transaction
        assertThat(results, hasItem(dividend( //
                        hasDate("2018-04-16T00:00"), hasExDate(null), //
                        hasShares(165.933), //
    ...
    public void testDividende10()
    {
        ...
        // check dividends transaction
        assertThat(results, hasItem(dividend( //
                        hasDate("2016-06-23T00:00"), hasExDate(null), //
                        hasShares(10.00), //
    ...
    public void testDividende11()
    {
        ...
        // check dividends transaction
        assertThat(results, hasItem(dividend( //
                        hasDate("2020-05-19T00:00"), hasExDate(null), //
                        hasShares(7.499), //
    ...
    public void testDividende13()
    {
        ...
        // check dividends transaction
        assertThat(results, hasItem(dividend( //
                        hasDate("2018-05-14T00:00"), hasExDate(null), //
                        hasShares(16.00), //
    ...
    public void testDividende14()
    {
        ...
        // check dividends transaction
        assertThat(results, hasItem(dividend( //
                        hasDate("2020-11-04T00:00"), hasExDate(null), //
                        hasShares(32.000), //
    ...
    public void testSteuerbehandlungVonDividende14()
    {
        ...
        assertThat(results, hasItem(taxes( //
                        ...
                        hasNote(null), //
                        hasAmount("EUR", 1.38 + 2.05 + 0.07 + 0.01), hasGrossValue("EUR", 1.38 + 2.05 + 0.07 + 0.01), //
                        hasTaxes("EUR", 0.00), hasFees("EUR", 0.00))));
    }
    ...
    public void testDividende14MitSteuerbehandlungVonDividende14()
    {
        ...
        assertThat(results, hasItem(dividend( //
                        ...
                        hasForexGrossValue("USD", 16.00), //
                        hasTaxes("EUR", 1.38 + 2.05 + 0.07 + 0.01), hasFees("EUR", 0.00))));
    }
    ...
    public void testDividende15()
    {
        ...
        // check dividends transaction
        assertThat(results, hasItem(dividend( //
                        hasDate("2021-01-07T00:00"), hasExDate(null), //
                        hasShares(34.000), //
    ...
    public void testDividende16()
    {
        ...
        // check dividends transaction
        assertThat(results, hasItem(dividend( //
                        hasDate("2021-12-31T00:00"), hasExDate(null), //
                        hasShares(81.921), //
    ...
    public void testDividende17()
    {
        ...
        // check dividends transaction
        assertThat(results, hasItem(dividend( //
                        hasDate("2010-12-15T00:00"), hasExDate(null), //
                        hasShares(1900.00), //
    ...
    public void testDividende18MitSteuerbehandlung()
    {
        ...
        // check dividends transaction
        assertThat(results, hasItem(dividend( //
                        hasDate("2009-04-27T00:00"), hasExDate(null), //
                        hasShares(3000.00), //
    ...
    public void testDividende19MitSteuerbehandlung()
    {
        ...
        // check dividends transaction
        assertThat(results, hasItem(dividend( //
                        hasDate("2008-05-15T00:00"), hasExDate(null), //
                        hasShares(80.000), //
    ...
    public void testDividende20MitSteuerbehandlung()
    {
        ...
        // check dividends transaction
        assertThat(results, hasItem(dividend( //
                        hasDate("2008-06-12T00:00"), hasExDate(null), //
                        hasShares(100.000), //
    ...
    public void testDividende21()
    {
        ...
        // check dividends transaction
        assertThat(results, hasItem(dividend( //
                        hasDate("2023-09-07T00:00"), hasExDate(null), //
                        hasShares(300.000), //
    ...
    public void testDividende22()
    {
        ...
        // check dividends transaction
        assertThat(results, hasItem(dividend( //
                        hasDate("2008-01-29T00:00"), hasExDate(null), //
                        hasShares(300.000), //
    ...
    public void testDividende23()
    {
        ...
        // check dividends transaction
        assertThat(results, hasItem(dividend( //
                        hasDate("2008-12-15T00:00"), hasExDate(null), //
                        hasShares(240.000), //
    ...
    public void testDividende24()
    {
        ...
        // check dividends transaction
        assertThat(results, hasItem(dividend( //
                        hasDate("2008-05-16T00:00"), hasExDate(null), //
                        hasShares(166.000), //
    ...
    public void testDividende25()
    {
        ...
        assertThat(results, hasItem(withFailureMessage( //
                        Messages.MsgErrorTransactionTypeNotSupportedOrRequired, //
                        dividend( //
                                        hasDate("2017-08-31T00:00"), hasExDate(null), //
                                        hasShares(3100.000), //
    ...
    public void testDividende27()
    {
        ...
        assertThat(results, hasItem(withFailureMessage( //
                        Messages.MsgErrorTransactionTypeNotSupportedOrRequired, //
                        dividend( //
                                        hasDate("2006-10-02T00:00"), hasExDate(null), //
                                        hasShares(67.000), //
    ...
    public void testDividende28()
    {
        ...
        // check dividends transaction
        assertThat(results, hasItem(dividend( //
                        hasDate("2023-11-03T00:00"), hasExDate(null), //
                        hasShares(0.516), //
    ...
    public void testDividende29()
    {
        ...
        // check dividends transaction
        assertThat(results, hasItem(dividend( //
                        hasDate("2023-11-16T00:00"), hasExDate(null), //
                        hasShares(10.512), //
    ...
    public void testDividende30()
    {
        ...
        // check dividends transaction
        assertThat(results, hasItem(dividend( //
                        hasDate("2023-09-13T00:00"), hasExDate(null), //
                        hasShares(2.867), //
    ...
    public void testDividende31()
    {
        ...
        // check dividends transaction
        assertThat(results, hasItem(dividend( //
                        hasDate("2024-02-19T00:00"), hasExDate(null), //
                        hasShares(35.845), //
    ...
    public void testDividende32()
    {
        ...
        // check dividends transaction
        assertThat(results, hasItem(dividend( //
                        hasDate("2024-06-19T00:00"), hasExDate(null), //
                        hasShares(80.000), //
    ...
    public void testDividende34()
    {
        ...
        // check dividends transaction
        assertThat(results, hasItem(dividend( //
                        hasDate("2025-11-14T00:00"), hasExDate(null), //
                        hasShares(60.000), //
    ...
    public void testDividende35()
    {
        ...
        // check dividends transaction
        assertThat(results, hasItem(dividend( //
                        hasDate("2025-04-01T00:00"), hasExDate(null), //
                        hasShares(36.000), //
    ...
    public void testSteuerbehandlungVonDividende35()
    {
        ...
        assertThat(results, hasItem(taxes( //
                        ...
                        hasNote(null), //
                        hasAmount("EUR", 4.23 + 6.35 + 0.23 + 0.01), hasGrossValue("EUR", 4.23 + 6.35 + 0.23 + 0.01), //
                        hasTaxes("EUR", 0.00), hasFees("EUR", 0.00))));
    }
    ...
    public void testDividende35MitSteuerbehandlungVonDividende35()
    {
        ...
        assertThat(results, hasItem(dividend( //
                        ...
                        hasForexGrossValue("USD", 45.72), //
                        hasTaxes("EUR", 4.23 + 6.35 + 0.23 + 0.01), hasFees("EUR", 0.00))));
    }
    ...
    public void testDividende36()
    {
        ...
        // check dividends transaction
        assertThat(results, hasItem(dividend( //
                        hasDate("2025-01-09T00:00"), hasExDate(null), //
                        hasShares(15.000), //
    ...
    public void testDividende37()
    {
        ...
        // check dividends transaction
        assertThat(results, hasItem(dividend( //
                        hasDate("2025-09-30T00:00"), hasExDate(null), //
                        hasShares(4.564), //
    ...
    public void testDividende38()
    {
        ...
        // check dividends transaction
        assertThat(results, hasItem(dividend( //
                        hasDate("2025-11-19T00:00"), hasExDate(null), //
                        hasShares(618.000), //
    ...
    public void testSteuerbehandlungVonDividende38()
    {
        ...
        assertThat(results, hasItem(taxes( //
                        ...
                        hasNote(null), //
                        hasAmount("EUR", 84.22 + 59.23 + 0.01), hasGrossValue("EUR", 84.22 + 59.23 + 0.01), //
                        hasTaxes("EUR", 0.00), hasFees("EUR", 0.00))));
    }
    ...
    public void testDividende38MitSteuerbehandlungVonDividende38()
    {
        ...
        assertThat(results, hasItem(dividend( //
                        ...
                        hasForexGrossValue("USD", 653.10), //
                        hasTaxes("EUR", 84.22 + 59.23 + 0.01), hasFees("EUR", 0.00))));
    }
    ...
    public void testDividende39()
    {
        ...
        // check dividends transaction
        assertThat(results, hasItem(dividend( //
                        hasDate("2026-01-15T00:00"), hasExDate(null), //
                        hasShares(2000.000), //
    ...
    public void testSteuerbehandlungVonDividende40()
    {
        ...
        assertThat(results, hasItem(taxes( //
                        ...
                        hasNote(null), //
                        hasAmount("EUR", 4.82 + 3.39 + 0.01), hasGrossValue("EUR", 4.82 + 3.39 + 0.01), //
                        hasTaxes("EUR", 0.00), hasFees("EUR", 0.00))));
    }
    ...
    public void testDividende41()
    {
        ...
        // check security
        assertThat(results, hasItem(security( //
                        hasIsin("FR0000120271"), hasWkn("850727"), hasTicker(null), //
    ...
    @Test
    public void testSteuerbehandlungVonDividende41()
    {
        var extractor = new ComdirectPDFExtractor(new Client());
        ...
        assertThat(results, hasItem(security( //
                        hasIsin("FR0000120271"), hasWkn("850727"), hasTicker(null), //
                        hasName("TOTALENERGIES SE EO 2,50"), //
                        hasCurrencyCode("EUR"))));

        // check tax refund transaction
        assertThat(results, hasItem(taxes( //
                        hasDate("2026-04-02T00:00"), hasShares(220.000), //
                        hasSource("SteuerbehandlungVonDividende41.txt"), //
                        hasNote(null), //
                        hasAmount("EUR", (46.75 - 23.94) + 23.94 + 24.06), hasGrossValue("EUR", (46.75 - 23.94) + 23.94 + 24.06), //
                        hasTaxes("EUR", 0.00), hasFees("EUR", 0.00))));
    }

    @Test
    public void testDividende41MitSteuerbehandlungVonDividende41()
    {
        var extractor = new ComdirectPDFExtractor(new Client());
    ...
    @Test
    public void testDividende41MitSteuerbehandlungVonDividende41_SourceFilesReversed()
    {
        var extractor = new ComdirectPDFExtractor(new Client());
    ...
    public void testDividende42MitSteuerbehandlungVonDividende42()
    {
        ...
        assertThat(results, hasItem(dividend( //
                        ...
                        hasNote("Ref.-Nr.: 1HINLIWN1N8001JK"), //
                        hasAmount("EUR", 5.57), //
    ...
    public void testFinanzreport13()
    {
        ...
        assertThat(firstError instanceof UnsupportedOperationException, is(true));
        assertThat(firstError.getMessage(), is(MessageFormat.format(Messages.PDFdbMsgCannotDetermineFileType, "Comdirect Bank AG",
                        "Finanzreport13.txt")));
    }
