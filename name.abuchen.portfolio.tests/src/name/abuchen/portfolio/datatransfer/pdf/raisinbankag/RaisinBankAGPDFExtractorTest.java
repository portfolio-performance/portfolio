...
public class RaisinBankAGPDFExtractorTest
{
    ...
    {
        var security = new Security("VANGUARD FTSE EMU.ETF DLD", "EUR");
        security.setIsin("IE00B3VVMM84");

        var client = new Client();
        client.addSecurity(security);

        var extractor = new RaisinBankAGPDFExtractor(client);
    ...
    public void testVorabpauschale01()
    {
        ...
        assertThat(results, hasItem(taxes( //
                        hasDate("2025-01-02T00:00"), hasShares(257.84), //
                        hasSource("Vorabpauschale01.txt"), //
                        hasNote("Dokument ID: 2B872G39-X017-1587-197O-25Ekj9aZ1321"), //
