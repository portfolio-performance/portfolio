...
public class HelloBankPDFExtractorTest
{
    ...
    @Test
    public void testWertpapierKauf01WithExistingSecurity()
    {
        Security security = new Security("M a r i n e  H a r v est ASA Navne-Aksjer NK 7,50", "NOK");
    ...
    @Test
    public void testWertpapierVerkauf01WithExistingSecurity()
    {
        Security security = new Security("S E L E C T  H A R V EST LTD. Registered Shares o.N.", "AUD");
    ...
    public void testDividende01()
    {
        ...
        Unit grossValueUnit = transaction.getUnit(Unit.Type.GROSS_VALUE)
                        .orElseThrow(IllegalArgumentException::new);
        assertThat(grossValueUnit.getForex(), is(Money.of("NOK", Values.Amount.factorize(640.00))));
    }

    @Test
    public void testDividende01WithExistingSecurity()
    {
        Security security = new Security("Marine Harvest ASA Navne-Aksjer NK 7,50", "NOK");
        security.setIsin("NO0003054108");
    ...
    public void testInboundDelivery01()
    {
        ...
        assertThat(transaction.getDateTime(), is(LocalDateTime.parse("2017-03-29T00:00")));
        assertThat(transaction.getShares(), is(Values.Share.factorize(80)));
        assertThat(transaction.getSource(), is("InboundDelivery01.txt"));
    ...
    public void testInboundDelivery02()
    {
        ...
        assertThat(transaction.getShares(), is(Values.Share.factorize(110)));
        assertThat(transaction.getSource(), is("InboundDelivery02.txt"));
