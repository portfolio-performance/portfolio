...
public class vbankagPDFExtractorTest
{
    ...
    public void testWertpapierKauf02()
    {
        ...
        assertThat(grossValueUnit.getForex(), is(Money.of(CurrencyUnit.USD, Values.Amount.factorize(16136.00))));
    }

    @Test
    public void testWertpapierKauf02WithSecurityInEUR()
    {
        Security security = new Security("Alger-Alger Amer.Ass.Gwth Fd Bearer Shares A o.N.", CurrencyUnit.EUR);
        ...
        VBankAGPDFExtractor extractor = new VBankAGPDFExtractor(client);
