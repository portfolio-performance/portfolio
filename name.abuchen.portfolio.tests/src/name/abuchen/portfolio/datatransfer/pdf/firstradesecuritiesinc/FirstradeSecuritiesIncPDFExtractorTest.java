...
public class FirstradeSecuritiesIncPDFExtractorTest
{
    ...
    public void testSecuritySale01()
    {
        ...
        var results = extractor.extract(PDFInputFile.loadTestCase(getClass(), "Sale01.txt"), errors);
    ...
    public void testSecuritySale02()
    {
        ...
        var results = extractor.extract(PDFInputFile.loadTestCase(getClass(), "Sale02.txt"), errors);
