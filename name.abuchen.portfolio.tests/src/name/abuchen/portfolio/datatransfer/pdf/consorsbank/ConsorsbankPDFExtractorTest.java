...
public class ConsorsbankPDFExtractorTest
{
    ...
    public void testWertpapierKauf14()
    {
        ...
        List<Item> results = extractor.extract(PDFInputFile.loadTestCase(getClass(), "ConsorsbankKauf14.txt"), errors);
    ...
    public void testWertpapierKauf15()
    {
        ...
        List<Item> results = extractor.extract(PDFInputFile.loadTestCase(getClass(), "ConsorsbankKauf15.txt"), errors);
    ...
    public void testWertpapierverkauf08()
    {
        ...
        List<Item> results = extractor.extract(PDFInputFile.loadTestCase(getClass(), "ConsorsbankVerkauf08.txt"), errors);
    ...
    public void testWertpapierverkauf09()
    {
        ...
        List<Item> results = extractor.extract(PDFInputFile.loadTestCase(getClass(), "ConsorsbankVerkauf09.txt"), errors);
    ...
    public void testWertpapierverkauf10()
    {
        ...
        List<Item> results = extractor.extract(PDFInputFile.loadTestCase(getClass(), "ConsorsbankVerkauf10.txt"), errors);
    ...
    public void testDividende01()
    {
        ...
        assertThat(transaction.getExDateTime(), is(LocalDateTime.parse("2015-05-08T00:00")));
    ...
    public void testDividende03()
    {
        ...
        assertThat(transaction.getExDateTime(), is(LocalDateTime.parse("2015-09-28T00:00")));
    ...
    public void testDividende04()
    {
        ...
        assertThat(transaction.getExDateTime(), is(LocalDateTime.parse("2015-05-13T00:00")));
    ...
    public void testDividende05()
    {
        ...
        assertThat(transaction.getExDateTime(), is(LocalDateTime.parse("2015-06-12T00:00")));
    ...
    public void testDividende06()
    {
        ...
        assertThat(transaction.getExDateTime(), is(LocalDateTime.parse("2015-12-22T00:00")));
    ...
    public void testDividende07()
    {
        ...
        assertThat(transaction.getExDateTime(), is(LocalDateTime.parse("2014-03-06T00:00")));
    ...
    public void testDividende08()
    {
        ...
        assertThat(transaction.getExDateTime(), is(LocalDateTime.parse("2016-05-06T00:00")));
