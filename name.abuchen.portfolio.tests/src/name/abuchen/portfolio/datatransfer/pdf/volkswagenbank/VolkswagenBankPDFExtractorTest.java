package name.abuchen.portfolio.datatransfer.pdf.volkswagenbank;
...
import name.abuchen.portfolio.datatransfer.pdf.VolkswagenBankPDFExtractor;
import name.abuchen.portfolio.model.Client;

@SuppressWarnings("nls")
public class VolkswagenBankPDFExtractorTest
{
    @Test
    public void testKontoauszug01()
    {
        var extractor = new VolkswagenBankPDFExtractor(new Client());
