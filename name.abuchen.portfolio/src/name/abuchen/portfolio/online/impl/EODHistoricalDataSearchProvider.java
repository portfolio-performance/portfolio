...
/**
 * <p>
 * Use the <a href="https://eodhistoricaldata.com/">EODHistoricalData.com</a> API to search for
 * securities by name, symbol or ISIN. This API can be used with the free API key that
 * you can obtain by registering on <a href="https://eodhistoricaldata.com/">EODHistoricalData.com</a>.
 * </p>
 * <p>
 * Refer to the <a href="https://eodhistoricaldata.com/financial-apis/search-api-for-stocks-etfs-mutual-funds-and-indices/">
 * EODHistoricalData.com Search API Documentation</a> for details of the supported parameters and examples.
 * </p>
 * <p>
...
public class EODHistoricalDataSearchProvider implements SecuritySearchProvider
{
    static class Result implements ResultItem
    {
        ...
        public static Optional<Result> from(JSONObject json)
        {
            ...
            if (previousClose != null && previousCloseDate != null)
            {
                ...
                {
                    // Ignore it and continue without adding a price to the security
                }
            }

            return Optional.of(new Result(symbol, String.valueOf(name), String.valueOf(type),
                            String.valueOf(exchange), String.valueOf(country), String.valueOf(currency), String.valueOf(isin),
                            String.valueOf(previousClose), String.valueOf(previousCloseDate), latestSecurityPrice));
        }

        private Result(String symbol, String name, String type, String exchange, String country, String currency, String isin,
                        String previousClose, String previousCloseDate, LatestSecurityPrice latestSecurityPrice)
        {
            this.symbol = symbol;
            this.name = name;
            this.type = type;
     ...
     * </p>
     * <p>
     * If the EODHistoricalData API key is null or blank then an empty <code>List</code>
     * is returned. This prevents <code>401 Unauthorized</code> errors for those
     * users who have not configured EODHistoricalData.
     * </p>
     * <p>
     * If the search query is null or blank then an empty <code>List</code>
     * is returned. This prevents pointless calls to the EODHistoricalData API.
     * </p>
     * 
     * @param query
