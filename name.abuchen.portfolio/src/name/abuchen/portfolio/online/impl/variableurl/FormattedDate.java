...
public class FormattedDate implements VariableURL
{
    private class DatesIterator implements Iterator<String>
    {
        ...
        private String resolve(LocalDate date)
        {
            ...
            Iterator<CharSequence> constants = FormattedDate.this.constants.iterator();
    ...
    private static final Pattern URL_MACRO_DATE = Pattern.compile("DATE:(.*?)");
    ...
    public FormattedDate(List<CharSequence> parts) throws IllegalArgumentException
    {
