...
public final class CorporateActionBasisAllocation
{
    ...
    private static Map<String, String> parseFields(String value)
    {
        ...
        if (value == null || value.isBlank())
            throw new IllegalArgumentException(
                            LedgerDiagnosticCode.LEDGER_CORE_025.message("Basis allocation value is required")); //$NON-NLS-1$
    ...
    {
        if (value == null || value.isBlank())
            throw new IllegalArgumentException(LedgerDiagnosticCode.LEDGER_CORE_025.message(message));
