...
public enum LedgerParameterType
{
    ...
    CORPORATE_ACTION_BASIS_STATUS("CORPORATE_ACTION_BASIS_STATUS", Scope.CORPORATE_ACTION, ValueKind.STRING,
                    LedgerParameterCodeDomain.CORPORATE_ACTION_BASIS_STATUS),
    CORPORATE_ACTION_BASIS_METHOD("CORPORATE_ACTION_BASIS_METHOD", Scope.CORPORATE_ACTION, ValueKind.STRING,
                    LedgerParameterCodeDomain.CORPORATE_ACTION_BASIS_METHOD),
    CORPORATE_ACTION_BASIS_ALLOCATION("CORPORATE_ACTION_BASIS_ALLOCATION", Scope.CORPORATE_ACTION,
                    ValueKind.STRING),
    CORPORATE_ACTION_BASIS_VALUATION_DATE("CORPORATE_ACTION_BASIS_VALUATION_DATE", Scope.CORPORATE_ACTION,
                    ValueKind.LOCAL_DATE),
    CORPORATE_ACTION_BASIS_MANUAL_OVERRIDE("CORPORATE_ACTION_BASIS_MANUAL_OVERRIDE", Scope.CORPORATE_ACTION,
                    ValueKind.BOOLEAN),
                    ...
                    LedgerParameterCodeDomain codeDomain)
    {
        ...
        if (codeDomain != null && expectedValueKind != ValueKind.STRING)
            throw new IllegalArgumentException(LedgerDiagnosticCode.LEDGER_CORE_016
    ...
    public static LedgerParameterType fromCode(String code)
    {
        ...
        throw new IllegalArgumentException(
                        LedgerDiagnosticCode.LEDGER_CORE_017.message("Unknown LedgerParameterType code: " + code)); //$NON-NLS-1$
    }
    ...
    public void requireValueKind(ValueKind valueKind)
    {
        if (!supportsValueKind(valueKind))
            throw new IllegalArgumentException(LedgerDiagnosticCode.LEDGER_CORE_018
