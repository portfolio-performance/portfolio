...
public final class LedgerXmlPersistenceSupport
{
    ...
    public static void configureXStream(XStream xstream)
    {
        ...
        xstream.alias("ledger-execution-ref", InvestmentPlan.LedgerExecutionRef.class);
    }
    ...
    private static void removeLegacyProjectionShadows(Client client)
    {
        convertPlanTransactionsToLedgerRefs(client);
    }

    private static void convertPlanTransactionsToLedgerRefs(Client client)
    {
