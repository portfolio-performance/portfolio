...
public class Client
{
    ...
    /**
     * Extension data for third-party extensions using protobuf Any type.
     * This preserves unknown extension data during load/save operations.
     */
     ...
     * @return unmodifiable list of protobuf Any objects containing extension data
     */
     ...
     * @param extensions list of protobuf Any objects containing extension data
     */
    ...
    /**
     * Add an extension to the client data.
     * @param extension protobuf Any object containing extension data
     */
