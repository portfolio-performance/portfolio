...
/* package */class CostCalculation extends Calculation
{
    ...
    public record CostCalculationResult(CostMethod costMethod, Money cost, Money netCost, long sharesHeld,
                    Optional<TrailRecord> trail,
    ...
    {
        return new CostCalculationResult(costMethod, getCost(TaxesAndFees.INCLUDED),
                        getCost(TaxesAndFees.NOT_INCLUDED), state.getSharesHeld(), state.getTrail(getTermCurrency()),
                        dividendCosts);
    }
