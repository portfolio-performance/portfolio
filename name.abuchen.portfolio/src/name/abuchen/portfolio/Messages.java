...
public class Messages extends NLS
{
    ...
    public static String LedgerInsertActionGeneratedBuyMissingBuySellEntry;
    public static String LedgerInsertActionGeneratedBuyTypeMismatch;
    public static String LedgerInsertActionGeneratedDeliveryOwnerNotFound;
    public static String LedgerInsertActionGeneratedDeliveryTypeMismatch;
    public static String LedgerInsertActionInvestmentPlanLegacySettersNotSupported;
    public static String LedgerInsertActionUnsupportedInvestmentPlanTransactionUpdateType;
    public static String LedgerParameterMissingAttribute;
    public static String LedgerParameterMissingType;
    public static String LedgerParameterMissingValueKind;
    public static String LedgerParameterReferenceValueMissingValueNode;
    public static String LedgerParameterUnsupportedValueKind;
    public static String LedgerParameterValueKindRequiresStructuredValue;
    public static String LedgerProtobufBooleanParameterMissingBooleanValue;
    public static String LedgerProtobufInvalidLedgerPersistenceState;
    public static String LedgerProtobufLocalDateParameterMissingLocalDateValue;
    public static String LedgerRuntimeProjectionRestorerInvalidLedger;
    public static String LedgerRuntimeProjectionRestorerPartiallyRestored;
    public static String LedgerRuntimeProjectionRestorerRestored;
    public static String LedgerStructuralValidatorAccountProjectionPortfolioNotAllowed;
    public static String LedgerStructuralValidatorDividendSecurityRequired;
    public static String LedgerStructuralValidatorDuplicateEntryUuid;
    public static String LedgerStructuralValidatorDuplicatePostingUuid;
    ...
    public static String LedgerStructuralValidatorProjectionRoleRequired;
    public static String LedgerStructuralValidatorProjectionRoleRequiredForType;
    public static String LedgerStructuralValidatorProjectionUuidRequired;
    public static String LedgerStructuralValidatorSignedFactsNotAllowed;
    public static String LedgerStructuralValidatorTargetingRefRequired;
    public static String LedgerXmlInvalidLedgerStructure;
