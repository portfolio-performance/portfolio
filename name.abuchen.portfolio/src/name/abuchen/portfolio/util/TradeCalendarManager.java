...
public class TradeCalendarManager
{
    ...
    static
    {
        ...
        // https://www.tradinghours.com/markets/tsx/holidays
        // https://www.public-holidays.us/CA_EN_2021_Toronto%20Stock%20Exchange
        ...
        tc.add(fixed(VICTORIA_DAY, Month.JANUARY, 25));
        tc.add(fixed(NATION_DAY, Month.JULY, 1).moveIf(DayOfWeek.SUNDAY, 2));
        ...
        tc.add(fixed(BOXING_DAY, Month.DECEMBER, 26).moveIf(DayOfWeek.SATURDAY, 2).moveIf(DayOfWeek.SUNDAY, 2)); 
        CACHE.put(tc.getCode(), tc);
