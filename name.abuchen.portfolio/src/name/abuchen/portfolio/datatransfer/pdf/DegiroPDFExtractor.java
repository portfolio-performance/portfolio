        ...
        blockBuyForex.set(new Transaction<BuySellEntry>().subject(() -> {
            ...
            return entry;
                        ...
                        .assign((t, v) -> {
                                ...
                                BigDecimal exchangeRate = v.asExchangeRate(v.get("exchangeRate")); // exchange rate in fx/EUR
                                ...
                                String currencyCode = v.asCurrencyCode(v.get("currency")); // "EUR"
                        ...
                        .assign((t, v) -> {
                            // set fee
                            Money feeAmount = Money.of(v.asCurrencyCode(v.get("currency")), v.asAmount(v.get("fee")));
