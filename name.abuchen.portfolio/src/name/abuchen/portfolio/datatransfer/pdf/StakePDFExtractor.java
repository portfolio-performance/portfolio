...
public class StakePDFExtractor extends AbstractPDFExtractor
{
    ...
    private void addBuySellTransaction()
    {
        ...
        pdfTransaction
                ...
                .match("^EFFECTIVE PRICE \\p{Sc}[\\.,\\d]+ TICKER (?<tickerSymbol>[\\w]{3,4})\\.ASX$")
                ...
                // AMOUNT DUE & PAYABLE A$10,458.04 Funds have already been deducted from your buying power. No action
    ...
    private <T extends Transaction<?>> void addFeesSectionsTransaction(T transaction, DocumentType type)
    {
        transaction
                ...
                .match("^BROKERAGE & GST A\\p{Sc}(?<fee>[\\.,\\d]+) SIDE (BUY|SELL)$")
