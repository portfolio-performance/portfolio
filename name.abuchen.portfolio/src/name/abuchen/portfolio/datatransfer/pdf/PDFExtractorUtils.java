...
class PDFExtractorUtils
{
    ...
    @SuppressWarnings("nls")
    public static long setNumberformat(String value, Values<Long> valueType, String language, String country) 
    {
    ...
    @SuppressWarnings("nls")
    public static BigDecimal setExchangeRateNumberformat(String value, Values<Long> valueType, String language, String country) 
    {
        DecimalFormat newNumberFormat = (DecimalFormat) NumberFormat.getInstance(new Locale(language, country));
