...
/* package */ final class PDFParser
{
    /* package */ static class DocumentType
    {
        ...
        public boolean matches(String text)
        {
            ...
            // Check if mustNotInclude patterns are present and exclude matches
            for (Pattern dontPattern : mustNotInclude)
            {
                if (dontPattern.matcher(text).find())
                    return false;
            }
         ...
         */
        public void parseContext(DocumentContext context, String[] lines)
        {
