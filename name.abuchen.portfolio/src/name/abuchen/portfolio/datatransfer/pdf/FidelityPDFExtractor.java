...
public class FidelityPDFExtractor extends AbstractPDFExtractor
{
    ...
    private void addSummaryStatementBuySellTransaction()
    {
        ...
        block.set(new Transaction<BuySellEntry>()
                        ...
                        .assign((t, v) -> {
                            // there is no currency in the text
                        ...
                        .assign((t, v) -> t.setAmount(asAmount(v.get("amount"), "en", "US")))
                        ...
                        .assign((t, v) -> {
                            t.getPortfolioTransaction()
                                        .addUnit(new Unit(Unit.Type.FEE,
                                                            Money.of(asCurrencyCode(("USD")),
                                                                            asAmount(v.get("fee"), "en", "US"))));
                        })
    ...
    private void addBuySellTransaction()
    {
        ...
        block.set(new Transaction<BuySellEntry>()
                        ...
                        .assign((t, v) -> {
                            ...
                            t.setDate(asDate(date, Locale.US));
                        })
                        ...
                        .section("gross", "tickerSymbol", "currency") //
                        .match("SECURITY DESCRIPTION SYMBOL: (?<tickerSymbol>[A-Z]{2,5}) Sale Proceeds\\s+(?<currency>\\p{Sc})(?<gross>[\\.,\\d]+)$") //
                        .assign((t, v) -> {
                        ...
                        .optional() //
                        .match(".*Total Fees\\s+(?<currency>\\p{Sc})(?<fee>[\\.,\\d]+)").assign((t, v) -> {
