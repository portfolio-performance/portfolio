...
public class DeutscheBankPDFExctractor extends AbstractPDFExtractor
{
    ...
    private void addBuyTransaction()
    {
        ...
        block.set(new Transaction<BuySellEntry>()
                        ...
                        .assign((t, v) -> t.getPortfolioTransaction().addUnit(new Unit(Unit.Type.FEE, //
                                        Money.of(v.asCurrencyCode(v.get("currency")), v.asAmount(v.get("provision"))))))
                        ...
                        .assign((t, v) -> t.getPortfolioTransaction().addUnit(new Unit(Unit.Type.FEE, //
                                        Money.of(v.asCurrencyCode(v.get("currency")), v.asAmount(v.get("additional"))))))

                        .section("xetra", "currency") //
                        .optional() //
                        .match("XETRA-Kosten (?<currency>\\w{3}+) (?<xetra>[\\d.]+,\\d+)")
                        .assign((t, v) -> t.getPortfolioTransaction().addUnit(new Unit(Unit.Type.FEE, //
                                        Money.of(v.asCurrencyCode(v.get("currency")), v.asAmount(v.get("xetra"))))))
    ...
    private void addSellTransaction()
    {
        ...
        block.set(new Transaction<BuySellEntry>()
                        ...
                        .assign((t, v) -> t.getPortfolioTransaction().addUnit(new Unit(Unit.Type.TAX, //
                                        Money.of(v.asCurrencyCode(v.get("currency")), v.asAmount(v.get("soli"))))))

                        .section("churchtax", "currency") //
                        .optional()
                        .match("Kirchensteuer auf Kapitalertragsteuer (?<currency>\\w{3}+) (?<churchtax>[\\d.-]+,\\d+)")
                        .assign((t, v) -> t.getPortfolioTransaction().addUnit(new Unit(Unit.Type.TAX, //
                                        Money.of(v.asCurrencyCode(v.get("currency")), v.asAmount(v.get("churchtax"))))))
                        ...
                        .assign((t, v) -> t.getPortfolioTransaction().addUnit(new Unit(Unit.Type.FEE, //
                                        Money.of(v.asCurrencyCode(v.get("currency")), v.asAmount(v.get("charges"))))))
