...
public class AdvanziaBankPDFExtractor extends AbstractPDFExtractor
{
    ...
    private void addCreditCardStatementTransaction()
    {
        ...
        depositBlock.set(new Transaction<AccountTransaction>()
                        ...
                        .section("date", "sign", "amount") //
                        .documentContext("currency") //
                        .match("^(?<date>[\\d]{2}\\.[\\d]{2}\\.[\\d]{4}) EINZAHLUNG (?<sign>\\-?)(?<amount>[\\.\\d]+,[\\d]{2}).*$") //
                        .assign((t, v) -> {
                            // Is sign --> not "-" change from DEPOSIT to REMOVAL
        ...
        interestChargeBlock.set(new Transaction<AccountTransaction>()
                        ...
                        .section("date", "sign", "amount") //
                        .documentContext("currency") //
                        .match("^(?<date>[\\d]{2}\\.[\\d]{2}\\.[\\d]{4}) SOLLZINSEN (?<sign>\\-?)(?<amount>[\\.\\d]+,[\\d]{2}).*$") //
                        .assign((t, v) -> {
