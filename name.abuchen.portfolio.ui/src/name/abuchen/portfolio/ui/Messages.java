...
public class Messages extends NLS
{
    ...
    public static String LedgerAccountTransactionsPaneUnsupportedSharesInlineEdit;
    public static String LedgerConvertPortfolioCompositeTypeActionUnsupportedLedgerBackedTransition;
    public static String LedgerConvertTransferToDepositRemovalActionCannotConvertLedgerBackedTransfer;
    public static String LedgerConvertTransferToDepositRemovalActionUnsupportedTransferEntry;
    public static String LedgerExDateEditingSupportDividendOwnerNotFound;
    public static String LedgerExDateEditingSupportNoSafeEditorLedgerBacked;
    public static String LedgerExDateEditingSupportNoSafeEditorPolicyBlocked;
    public static String LedgerNativeComponentInspectorCardinality;
    public static String LedgerNativeComponentInspectorCode;
    public static String LedgerNativeComponentInspectorDateTime;
    public static String LedgerNativeComponentInspectorDialogTitle;
    public static String LedgerNativeComponentInspectorDomain;
    public static String LedgerNativeComponentInspectorEntryParameters;
    public static String LedgerNativeComponentInspectorEntryType;
    public static String LedgerNativeComponentInspectorEntryUUID;
    public static String LedgerNativeComponentInspectorField;
    public static String LedgerNativeComponentInspectorFunctionalLegs;
    public static String LedgerNativeComponentInspectorGroupExpected;
    public static String LedgerNativeComponentInspectorHeader;
    public static String LedgerNativeComponentInspectorLegRole;
    public static String LedgerNativeComponentInspectorMenu;
    public static String LedgerNativeComponentInspectorNativeTargeted;
    public static String LedgerNativeComponentInspectorNoNativeDefinition;
    public static String LedgerNativeComponentInspectorOwner;
    public static String LedgerNativeComponentInspectorParameter;
    public static String LedgerNativeComponentInspectorPostingGroupUUID;
    public static String LedgerNativeComponentInspectorPostingParameters;
    public static String LedgerNativeComponentInspectorPostings;
    public static String LedgerNativeComponentInspectorPostingType;
    ...
    public static String LedgerNativeComponentInspectorSelectedPostingGroupUUID;
    public static String LedgerNativeComponentInspectorSelectedPrimaryPostingUUID;
    public static String LedgerNativeComponentInspectorSelectedProjectionRole;
    public static String LedgerNativeComponentInspectorShape;
    public static String LedgerNativeComponentInspectorValue;
    public static String LedgerNativeComponentInspectorValueKind;
    public static String LedgerPropertyEditingSupportUnsupportedInlineEdit;
    public static String LedgerTransactionOwnerListEditingSupportAccountTransferOwnerNotFound;
    public static String LedgerTransactionOwnerListEditingSupportDistinctOwnersRequired;
    public static String LedgerTransactionOwnerListEditingSupportPortfolioTransferOwnerNotFound;
    public static String LedgerTransactionOwnerListEditingSupportUnsupportedOwnerEdit;
    public static String LedgerTransactionOwnerListEditingSupportUnsupportedOwnerType;
    public static String LedgerTransactionsViewerUnsupportedSharesInlineEdit;
    public static String LedgerTransactionTypeEditingSupportPolicyBlockedTransition;
    public static String LedgerTransactionTypeEditingSupportUnsupportedTransition;
