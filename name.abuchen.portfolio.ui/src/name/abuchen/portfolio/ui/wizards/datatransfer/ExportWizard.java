...
import name.abuchen.portfolio.datatransfer.csv.RentabloNetExporter;
    ...
    public boolean performFinish()
    {
        ...
        try
        {
            ...
            else if (exportClass == Security.class)
            {
                ...
                else if (Messages.ExportWizardAllTransactionsRentabloDE.equals(exportItem))
                    new RentabloNetExporter().exportAllTransactions(file, client);
