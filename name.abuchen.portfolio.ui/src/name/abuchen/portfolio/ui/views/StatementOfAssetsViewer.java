...
public class StatementOfAssetsViewer
{
                    ...
                    List<ReportingPeriod> reportingPeriods)
    {
        ...
        column = new Column("purchaseValueIncludingTaxesAndFees", formatCostMethod(Messages.ColumnPurchaseValueIncludingTaxesAndFees_Header, costMethod), SWT.RIGHT, 80) //$NON-NLS-1$
                        .addAliasIDs("8", "pvmvavg"); //$NON-NLS-1$ //$NON-NLS-2$
                                                      // //$NON-NLS-3$
        ...
        column = new Column("profitLossIncludingTaxesAndFees", formatCostMethod(Messages.ColumnProfitLossIncludingTaxesAndFees_Header, costMethod), SWT.RIGHT, 80) //$NON-NLS-1$
                        .addAliasIDs("9", "pl_moving_average", "profitLoss"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    private void addPurchaseCostColumns(ShowHideColumnHelper columns, CostMethod costMethod)
    {
        ...
        Column column = new Column("purchasePriceExcludingTaxesAndFees", formatCostMethod(Messages.ColumnPurchasePriceExcludingTaxesAndFees_Header, costMethod), SWT.RIGHT, 60) //$NON-NLS-1$
                        .addAliasIDs("7", "ppmvavg"); //$NON-NLS-1$ //$NON-NLS-2$
                                                      // //$NON-NLS-3$
        ...
        column = new Column("purchasePriceIncludingTaxesAndFees", formatCostMethod(Messages.ColumnPurchasePriceIncludingTaxesAndFees_Header, costMethod), SWT.RIGHT, 60) //$NON-NLS-1$
                        .addAliasIDs("grossPurchasePriceFIFO", "grossPurchasePriceMA"); //$NON-NLS-1$ //$NON-NLS-2$
                                                                                        // //$NON-NLS-3$
                    ...
                    CostMethod costMethod)
    {
        ...
        column = new Column("capitalGains", formatCostMethod(Messages.ColumnCapitalGains_Header, costMethod), //$NON-NLS-1$
    ...
    private void addDividendColumns(ShowHideColumnHelper columns, List<ReportingPeriod> options, CostMethod costMethod)
    {
        ...
        labelProvider = new ReportingPeriodLabelProvider(record -> record.getTotalRateOfReturnDiv(costMethod), null,
                        false);
        column.setOptions(new ReportingPeriodColumnOptions(
                        formatCostMethod(Messages.ColumnDividendTotalRateOfReturn_Header, costMethod) + " {0}", //$NON-NLS-1$
                        options));
        column.setGroupLabel(Messages.GroupLabelDividends);
    ...
    /* package */ void addCurrencyColumns(ShowHideColumnHelper columns, CostMethod costMethod) // NOSONAR
    {
        ...
        column = new Column("purchaseValueBaseCurrencyIncludingTaxesAndFees", //$NON-NLS-1$
                        formatCostMethod(Messages.ColumnPurchaseValueBaseCurrencyIncludingTaxesAndFees_Header, costMethod), SWT.RIGHT, 80);
        column.addAliasIDs("purchaseValueBaseCurrency"); //$NON-NLS-1$
        column.setDescription(formatCostMethod(Messages.ColumnPurchaseValueBaseCurrencyIncludingTaxesAndFees_Description, costMethod));
        column.setGroupLabel(Messages.ColumnForeignCurrencies);
        labelProvider = new ReportingPeriodLabelProvider(
        ...
        column = new Column("purchasePriceBaseCurrencyExcludingTaxesAndFees", //$NON-NLS-1$
                        formatCostMethod(Messages.ColumnPurchasePriceBaseCurrencyExcludingTaxesAndFees_Header, costMethod), SWT.RIGHT, 80);
        column.addAliasIDs("purchasePriceBaseCurrency"); //$NON-NLS-1$
        column.setDescription(formatCostMethod(Messages.ColumnPurchasePriceBaseCurrencyExcludingTaxesAndFees_Description, costMethod));
        column.setGroupLabel(Messages.ColumnForeignCurrencies);
        labelProvider = new ReportingPeriodLabelProvider(new ElementValueProvider(
                        record -> record.getCostPerSharesHeld(costMethod, TaxesAndFees.NOT_INCLUDED), null),
                        e -> e.isSecurity() ? e.getSecurity().getCurrencyCode()
        ...
        column = new Column("profitLossBaseCurrencyIncludingTaxesAndFees", //$NON-NLS-1$
                        formatCostMethod(Messages.ColumnProfitLossBaseCurrencyIncludingTaxesAndFees_Header, costMethod), SWT.RIGHT, 80);
        column.addAliasIDs("profitLossBaseCurrency"); //$NON-NLS-1$
        column.setDescription(formatCostMethod(Messages.ColumnProfitLossBaseCurrencyIncludingTaxesAndFees_Description, costMethod));
        column.setGroupLabel(Messages.ColumnForeignCurrencies);
        labelProvider = new ReportingPeriodLabelProvider(
                    ...
                    implements Comparator<Object>
    {
        ...
        public ReportingPeriodLabelProvider(Function<LazySecurityPerformanceRecord, ?> valueProvider)
        {
