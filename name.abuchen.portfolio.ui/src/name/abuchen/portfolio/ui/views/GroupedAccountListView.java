...
public class GroupedAccountListView extends AbstractFinanceView implements ModificationListener
{
    ...
    {
        toolBar.add(new DropDown(Messages.MenuCreateAndManageClientFilter, Images.PLUS, SWT.NONE,
                        manager -> {
    ...
    protected Control createBody(Composite parent)
    {
        ...
        column.setLabelProvider(new ColumnLabelProvider()
        {
            ...
            public String getText(Object element)
            {
                ...
                {
                    PortfolioSnapshot snapshot = PortfolioSnapshot.create(portfolio, converter,
                                    LocalDate.now());
