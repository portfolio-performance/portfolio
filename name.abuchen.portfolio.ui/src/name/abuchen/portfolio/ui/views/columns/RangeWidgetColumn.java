...
public class RangeWidgetColumn extends Column
{
    private static final class QuoteReportingPeriodLabelProvider extends ParameterizedColumnLabelProvider
    {
        ...
        public QuoteReportingPeriodLabelProvider(BiFunction<Object, ReportingPeriod, AllTimeHigh> valueProvider, Table table)
        {
            this.valueProvider = valueProvider;
            enableOwnerDraw(table);
        }
        ...
        public String getToolTipText(Object e)
        {
            ...
            return String.format("%s (%s) - %s (%s)",
                ...
                Values.Date.format(range.getHighDate())); //$NON-NLS-1$
        }
    ...
    public RangeWidgetColumn(Supplier<LocalDate> dateProvider, List<ReportingPeriod> options, Table table)
    {
        ...
        this.setLabelProvider(() -> new QuoteReportingPeriodLabelProvider(valueProvider, table));
        ...
        this.setSorter(ColumnViewerSorter.create((o1, o2) -> {
            ...
            Double v1 = valueProvider.apply(o1, option).getRelLowDistance();
            Double v2 = valueProvider.apply(o2, option).getRelLowDistance();
