    ...
    private void updateChart()
    {
        ...
        try
        {
            ...
            if (showAreaRelativeToFirstQuote)
            {
                ...
                configureSeriesPainter(lineSeries2ndNegative, javaDates, valuesRelativeNegative, colorQuoteAreaNegative, 1,
                ...
                configureSeriesPainter(lineSeries2ndPositive, javaDates, valuesRelativePositive, colorQuoteAreaPositive, 1,
                                LineStyle.SOLID, true, false);
            }
