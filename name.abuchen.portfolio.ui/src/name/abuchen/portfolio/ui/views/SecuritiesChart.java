...
public class SecuritiesChart
{
    ...
    private void addExtremesMarkerLines(ChartInterval chartInterval)
    {
        ...
        max.ifPresent(high -> addExtremeMarker(high, PlotSymbolType.TRIANGLE, 10, Messages.LabelChartDetailMarkerHigh, colorHigh));
        min.ifPresent(low -> addExtremeMarker(low, PlotSymbolType.INVERTED_TRIANGLE, -25, Messages.LabelChartDetailMarkerLow, colorLow));
    }

    private void addExtremeMarker(SecurityPrice price, PlotSymbolType plotSymbolType, int labelOffset, String seriesLabel, Color color)
    {
        ...
        else
        {
            ...
            inner.setSymbolColor(color);
            configureSeriesPainter(inner, new Date[] {zonedDate}, new double[] {value}, color, 0, LineStyle.NONE, false, true);
