...
public class TradesTableViewer
{
    ...
    void createTradesColumns(ShowHideColumnHelper support, ViewMode viewMode, CostMethod costMethod)
    {
        ...
        column = new Column("entryValueIncludingTaxesAndFees", formatCostMethod(Messages.ColumnEntryValueIncludingTaxesAndFees_Header, costMethod), SWT.RIGHT, 80) //$NON-NLS-1$
                        .addAliasIDs("entryvalue", "entryvalue-mvavg"); //$NON-NLS-1$ //$NON-NLS-2$
                                                                        // //$NON-NLS-3$
        ...
        column = new Column("entryValuePerShareIncludingTaxesAndFees", //$NON-NLS-1$
                        formatCostMethod(Messages.ColumnEntryValuePerShareIncludingTaxesAndFees_Header, costMethod),
                        SWT.RIGHT, 80)
                                        .addAliasIDs("entryvalue-pershare", "entryvalue-mvavg-pershare"); //$NON-NLS-1$ //$NON-NLS-2$
        column.setGroupLabel(Messages.ColumnEntryValue);
        ...
        column = new Column("profitLossIncludingTaxesAndFees", formatCostMethod(Messages.ColumnProfitLossIncludingTaxesAndFees_Header, costMethod), SWT.RIGHT, 80) //$NON-NLS-1$
                        .addAliasIDs("pl", "pl-mvavg"); //$NON-NLS-1$ //$NON-NLS-2$
                                                        // //$NON-NLS-3$
        ...
        column = new Column("profitLossExcludingTaxesAndFees", formatCostMethod(Messages.ColumnProfitLossExcludingTaxesAndFees_Header, costMethod), SWT.RIGHT, 80) //$NON-NLS-1$
                        .addAliasIDs("gpl", "gpl-mavg"); //$NON-NLS-1$ //$NON-NLS-2$
                                                         // //$NON-NLS-3$
        column.setGroupLabel(Messages.ColumnProfitLoss);
        ...
        column = new Column("returnRate", formatCostMethod(Messages.ColumnReturnRate_Header, costMethod), SWT.RIGHT, 80) //$NON-NLS-1$
