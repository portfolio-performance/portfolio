...
//        }
    ...
    private void createQuarterColumns(TableViewer records, TableColumnLayout layout)
    {
        ...
        {            
            ...
            String columnCaption = String.format("Q%d %s", quarterWithinYear, formatter.format(date));
    ...
    /**
     * @brief Creates a column collecting quarter-wise dividends.
     * 
     * The quarter is specified by the start and end position within the values array
     * of the Line within the DividendsViewModel.
     * 
     * @param quarterBeginIndex The start index of the quarter
     * @param quarterEndIndex The end index of the quarter
     * @param columnCaption The caption used for the column
     */
