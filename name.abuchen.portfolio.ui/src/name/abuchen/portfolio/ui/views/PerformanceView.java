...
public class PerformanceView extends AbstractHistoricView
{
    ...
    protected Control createBody(Composite parent)
    {
        ...
        snapshotStart = createStatementOfAssetsItem(folder, Messages.PerformanceTabAssetsAtStart, "performance.start"); //$NON-NLS-1$
        ...
        snapshotEnd = createStatementOfAssetsItem(folder, Messages.PerformanceTabAssetsAtEnd, "performance.end"); //$NON-NLS-1$
