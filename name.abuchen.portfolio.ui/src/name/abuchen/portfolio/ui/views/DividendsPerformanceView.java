...
//        ColumnViewerSorter.create(DivRecord.class, "security").attachTo(tree, tvcol, true); //$NON-NLS-1$
        // ColumnViewerSorter: es muss eine getXxx-Methode in der DivRecord-Klasse existieren, sonst crasht es !!!
        
        Helper.Assert (cc == colB_InternalRateOfReturn); cc++;
        // IZF über alles
        ...
        // Rendite insgesamt
        Helper.Assert (cc == colF_TotalRateOfDividendReturn); cc++;
        tvcol = new TreeViewerColumn(tree, SWT.RIGHT);
        column = tvcol.getColumn();
        column.setText("Div%");
        column.setWidth(50);
        ...
        Helper.Assert (cc == colG_InternalRateOfDivReturn); cc++;
        tvcol = new TreeViewerColumn(tree, SWT.RIGHT);
        column = tvcol.getColumn();
        column.setText("øDiv%"); 
        column.setWidth(50);
        ...
        Helper.Assert (cc == colH_DivEventCount); cc++;
        column = new TreeColumn(tree.getTree(), SWT.RIGHT);
        column.setText("#Div");
        column.setWidth(25);

        // Datum der letzten Dividendenzahlung | Vorgangsdatum
        Helper.Assert (cc == colI_LastReturn); cc++;
        tvcol = new TreeViewerColumn(tree, SWT.None);
        column = tvcol.getColumn();
        ...
        Helper.Assert (cc == colJ_Periodicity); cc++;
        tvcol = new TreeViewerColumn(tree, SWT.None);
        column = tvcol.getColumn();
        ...
        Helper.Assert (cc == colM_Dividends12PerShare); cc++;
        column = new TreeColumn(tree.getTree(), SWT.RIGHT);
        column.setText("øDiv¹²");
        column.setWidth(50);

        // Einstand pro Stück
        Helper.Assert (cc == colN_Cost12Amount); cc++;
        column = new TreeColumn(tree.getTree(), SWT.RIGHT);
        column.setText("Einstand¹²");
        column.setWidth(50);

        // persönliche Dividende im letzen Jahr
        Helper.Assert (cc == colO_PersonalRateOfDividendReturn); cc++;
        tvcol = new TreeViewerColumn(tree, SWT.RIGHT);
        column = tvcol.getColumn();
        ...
        Helper.Assert (cc == colP_Dividends12Expected); cc++;
        tvcol = new TreeViewerColumn(tree, SWT.RIGHT);
        column = tvcol.getColumn();
        ...
        Helper.Assert (cc == colQ_DividendIncreasingRate); cc++;
        tvcol = new TreeViewerColumn(tree, SWT.RIGHT);
        column = tvcol.getColumn();
        column.setText("DSR%");
        column.setWidth(50);
        ...
        Helper.Assert (cc == colR_DivExpectedLongTerm); cc++;
        tvcol = new TreeViewerColumn(tree, SWT.RIGHT);
        column = tvcol.getColumn();
                    ...
                    ITableColorProvider
    {
        ...
        public String getColumnText(Object element, int columnIndex)
        {
            ...
            if (element instanceof DivRecord)
            {
                ...
                if (!divRecord.getHasDiv12() && (columnIndex > colJ_Periodicity)) return null;
                ...
                switch (columnIndex)
                {
                    ...
                    case colL_Dividends12: // Summe der Dividenden der letzen 12 Monate
                        return Values.Amount.format(divRecord.getDiv12Amount());
                    case colM_Dividends12PerShare: // Dividenden pro Stück der letzten 12 Monate 
                    ...
                    case colO_PersonalRateOfDividendReturn: // persönliche Rendite
            ...
            if (element instanceof DivRecord)
            {
                ...
                switch (columnIndex)
                {
                    ...
                    case colE_DividendSum:
                        return record.getDivAmount() >= 0 ? getColor(SWT.COLOR_DARK_GREEN) : getColor(SWT.COLOR_DARK_RED);
                }
            }
