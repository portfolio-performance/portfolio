...
public class TaxonomiePieChartSWT implements IPieChart
{
    ...
    private void addNodes(Map<String, NodeData> dataMap, Map<String, Color> colors, Node node, TaxonomyNode parentNode, List<TaxonomyNode> children, Money total, boolean excludeSecurities)
    {
