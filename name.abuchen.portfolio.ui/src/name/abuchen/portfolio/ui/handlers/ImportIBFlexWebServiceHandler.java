...
public class ImportIBFlexWebServiceHandler
{
    ...
    private void runImport(PortfolioPart part, Shell shell, Client client, String selectedQueryId)
    {
        ...
        LocalDateTime lastImportDate = IBFlexConfigurationDialog.getLastImportDate(client, finalQueryId);
        ...
        try
        {
            ...
            dialog.run(true, true, monitor -> {
                ...
                try
                {
                    ...
                    String xml = webClient.fetchStatement(finalToken, finalQueryId);
            ...
            {
                IBFlexConfigurationDialog.setLastImportDate(client, finalQueryId, maxDate);
            }
        }
