...
public class ConfirmActionWithSelection extends Action
{
    ...
    public ConfirmActionWithSelection(String title, String singleSelectionMessage, String multiSelectionMessage, int style, IStructuredSelection selection, Runnable runnable)
    {
        super(title, style);
    ...
    public void run()
    {
        if(true == MessageDialog.openConfirm(Display.getDefault().getActiveShell(), getText(), getMessageForSelection())) {
