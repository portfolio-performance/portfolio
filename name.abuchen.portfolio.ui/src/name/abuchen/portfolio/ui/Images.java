...
public enum Images
{
    ...
    // Buttons, Table menu and toggle icons
    ...
    DELETE_FILE("delete_file.png"), //$NON-NLS-1$
    NEW_FILE("new_file.png"), //$NON-NLS-1$
    OPEN_FILE("open_file.png"), //$NON-NLS-1$
    CLOSE_FILE("close_file.png"), //$NON-NLS-1$
    SEARCH_FILE("search_file.png"), //$NON-NLS-1$
    SAVE_FILE("save_file.png"), //$NON-NLS-1$
    SAVEAS_FILE("saveAs_file.png"), //$NON-NLS-1$
    SAVEALL_FILE("saveAll_file.png"), //$NON-NLS-1$
    IMPORT_FILE("import_file.png"), //$NON-NLS-1$
    EXPORT_FILE("export_file.png"), //$NON-NLS-1$
    TEMPLATE_FILE("template_file.png"), //$NON-NLS-1$
    TEMPLATE_FILES("template_files.png"), //$NON-NLS-1$
    CSV_FILE("csv_file.png"), //$NON-NLS-1$
    PDF_FILE("pdf_file.png"), //$NON-NLS-1$
    AES_FILE("aes_file.png"), //$NON-NLS-1$
    AES_FILE_COMPRESSION("aes_file_compression.png"), //$NON-NLS-1$
    BINARY_FILE("binary_file.png"), //$NON-NLS-1$
    BINARY_FILE_COMPRESSION("binary_file_compression.png"), //$NON-NLS-1$
    XML_FILE("xml_file.png"), //$NON-NLS-1$
    XML_FILE_COMPRESSION("xml_file_compression.png"), //$NON-NLS-1$
    XML_QUERY_FILE("xml_query_file_.png"), //$NON-NLS-1$

    // Main menu (single use)
    ANALYSE("analyse.png"), //$NON-NLS-1$
    CODE_FORK("code_fork.png"), //$NON-NLS-1$
    CURRENCY("currency.png"), //$NON-NLS-1$
    ERROR_NOTIFICATION("error_notification.png"), //$NON-NLS-1$
    FAQ("faq.png"), //$NON-NLS-1$
    FORUM("forum.png"), //$NON-NLS-1$
    INSTRUCTION("instruction.png"), //$NON-NLS-1$
    LOADING_QUOTE("loading_quote.png"), //$NON-NLS-1$
    LOADING_ALL_QUOTE("loading_all_quote.png"), //$NON-NLS-1$
    SETTINGS("settings.png"), //$NON-NLS-1$
    NEWS("news.png"), //$NON-NLS-1$
    RESET_GUI("reset_gui.png"), //$NON-NLS-1$
    SAVE_ERRORLOG("save_errorlog.png"), //$NON-NLS-1$
    SHUTDOWN("shutdown.png"), //$NON-NLS-1$
    TRASH("trash.png"), //$NON-NLS-1$

    // Attribute
    ATTRIBUTE("attribute.png"), //$NON-NLS-1$

    // Interval, clock and time
    INTERVAL("interval.png"), //$NON-NLS-1$
    TIME("time.png"), //$NON-NLS-1$
